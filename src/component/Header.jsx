    ...
    <header className="header" id="header">
        <nav className="navbar container">
            <div className="nav__logo-container">
                <img src="./assets/logo/Logo.png" alt="Raul Tindogan" className="nav__logo" />
            </div>
            <ul className="nav__desktop-link-container">
                ...
                <li><a href="#" className="resume--button">RESUME</a></li>
            </ul>
        ...
        <div className={mobile_menu}>
            <ul className="nav__mobile-link-container">
                <a href="#" className="nav__mobile--link"><li >HOME</li></a>
                <a href="#" className="nav__mobile--link"><li>ABOUT</li></a>
                <a href="#" className="nav__mobile--link"><li>PROJECTS</li></a>
                <li className="resume--link"><a href="#" className="resume--button">RESUME</a></li>
